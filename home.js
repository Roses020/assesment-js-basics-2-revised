...
/* 
    ...
    'Welcome back, [USERNAME]'  Write an *arrow* function called `greetUser`
...
/* 
      ...
      consoBelow is an array of zip codes that are in
...
function canWeDeliverTwo(zipCode){ 
    const zipCodeExists = deliveryAreaZipCodes.includes(zipCode)
    if(zipCodeExists){
     return "you are in our delivery Zone"
    }
     return  "sorry, we cant deliver to that address"
